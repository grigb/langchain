...
Before a substantive owner-facing status, progress update, recommendation,
decision/choice surface, blocker/gate message, dispatch update, result
assimilation, or closeout, agents MUST read
`/Users/grig/.agents/style-guides/writing/OWNER-FACING-AGENT-MESSAGE-STYLE-GUIDE.md`
unless they have already read it in the current session.
